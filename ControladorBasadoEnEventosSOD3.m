classdef ControladorBasadoEnEventosSOD3 < handle
    properties
        num
        den
        Ts
    ...
    methods
        function obj = ControladorBasadoEnEventosSOD3(num, den, Ts, ref, kp, ki, elim, hmax, Sat, nit)
            obj.num = num;
            obj.den = den;
            obj.Ts = Ts;
            obj.ref = ref;
...
%         end
        ...
        function [best_elim, best_hmax] = calcularValoresOptimos(obj)
            Elim_range = 0:0.02:1;
