function varargout = event_based16(varargin)
% EVENT_BASED16 MATLAB code for event_based16.fig
%      EVENT_BASED16, by itself, creates a new EVENT_BASED16 or raises the existing
%      singleton*.
%
%      H = EVENT_BASED16 returns the handle to a new EVENT_BASED16 or the handle to
%      the existing singleton*.
%
%      EVENT_BASED16('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in EVENT_BASED16.M with the given input arguments.
%
%      EVENT_BASED16('Property','Value',...) creates a new EVENT_BASED16 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before event_based16_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to event_based16_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help event_based16

% Last Modified by GUIDE v2.5 10-Sep-2024 19:52:15

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @event_based16_OpeningFcn, ...
                   'gui_OutputFcn',  @event_based16_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before event_based16 is made visible.
function event_based16_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to event_based16 (see VARARGIN)

% Choose default command line output for event_based16
...
% UIWAIT makes event_based16 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = event_based16_OutputFcn(hObject, eventdata, handles) 
...
function pushbutton6_Callback(hObject, eventdata, handles)
    ...
    controlador = ControladorBasadoEnEventosSOD3(num, den, Ts, ref, kp, ki, 0, 0, Sat, nit);

    % Calcular los valores óptimos
    [best_elim, best_hmax] = controlador.calcularValoresOptimos();
